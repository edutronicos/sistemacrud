...
<div class="flex h-full">
    ...
    <div class="flex flex-col items-center w-full bg-gray-300">
        ...
        <div class="m-12 p-6 rounded-lg bg-slate-700 w-full max-w-2xl shadow-lg">
            <form action="/logos_gravar" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex mb-6 items-center">
                    <div class="w-1/3">
                        <label class="font-semibold text-zinc-100" for="">Tamanho</label>
                    </div>
                    <div class="w-2/3">
                        <select class="w-32 h-8 rounded pl-2" name="tamanho" id="">
                            <option value=""></option>
                ...
                <div class="flex justify-center items-center w-full">
                    <div class="w-1/3">
                        <label class="font-semibold text-zinc-100" for="">Imagem (LOGO)</label>
                    </div>
                    <div class="w-2/3">
