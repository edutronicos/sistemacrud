...
<div class="flex h-full">
    ...
    <div class="flex flex-col items-center w-full bg-gray-300">
        ...
        <div class="m-12 p-6 rounded-lg bg-slate-700 w-full max-w-2xl shadow-lg">
            <form action="/certificado_gravar" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex mb-6 items-center">
                    <div class="w-1/3">
                        <label class="font-semibold text-zinc-100" for="">Validade</label>
                    </div>
                    <div class="w-2/3">
                ...
                <div class="flex justify-center items-center w-full">
                    <div class="w-1/3">
                        <label class="font-semibold text-zinc-100" for="">Certificado</label>
                    </div>
                    <div class="w-2/3">
