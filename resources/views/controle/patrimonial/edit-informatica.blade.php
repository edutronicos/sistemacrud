            ...
            <div class="text-center">
                ...
                @csrf
                        ...
                        <label class="text-black font-semibold">Periféricos</label>
                            <div class="flex justify-start">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" name="perifericos[]" value="Mouse" @if (stristr($dados->perifericos, "mouse")) checked @endif>
                                    <label class="form-check-label inline-block text-gray-800 mr-2" for="inlineCheckbox1">Mouse</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" type="checkbox" name="perifericos[]" value="Teclado" @if (stristr($dados->perifericos, "teclado")) checked @endif>
                                    <label class="form-check-label inline-block text-gray-800 mr-2" for="inlineCheckbox2">Teclado</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2" type="checkbox" name="perifericos[]" value="Mouse-Pad" @if (stristr($dados->perifericos, "Mouse-Pad")) checked @endif>
                                    <label class="form-check-label inline-block text-gray-800 mr-2" for="inlineCheckbox3">Mouse-Pad</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2" type="checkbox" name="perifericos[]" value="Não-Possui" @if (stristr($dados->perifericos, "Não-Possui")) checked @endif>
                    ...
                    <div class="flex flex-col col-span-3">
                        ...
                        <textarea class="w-3/4 rounded text-black font-medium" name="descricao" id="descricao" cols="15" rows="5" placeholder="">{{$dados->descricao}}</textarea>
                    </div>
                    <div>
